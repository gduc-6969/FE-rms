      ...
      @if (loading()) {
        ...
        <div class="stats-row">
          <div class="stat-card">
            ...
            <div class="stat-value">{{ summary()?.totalRevenue | currency:'USD':'symbol':'1.0-0' }}</div>
          </div>
          <div class="stat-card">
            <div class="stat-label">Avg Order Value</div>
            <div class="stat-value">{{ summary()?.avgOrderValue | currency:'USD':'symbol':'1.0-0' }}</div>
          </div>
          <div class="stat-card">
            ...
            <tbody>
              @for (dish of bestSellers(); track dish.rank) {
                <tr>
                  ...
                  <td class="td-revenue">{{ dish.revenue | currency:'USD':'symbol':'1.0-0' }}</td>
                  <td>
